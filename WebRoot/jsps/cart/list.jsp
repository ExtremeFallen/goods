...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/BookServlet?bid=${cartItem.book.bid }&method=load'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_b }'/>"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/BookServlet?bid=${cartItem.book.bid }&method=load'/>"><span>${cartItem.book.bname }</span></a>
		</td>
